...
try {
    ...
    $count_query = "SELECT COUNT(*) FROM return_to_work WHERE status = 'Declined' AND department = ?";
    ...
    $query = "SELECT * FROM return_to_work WHERE status = 'Declined' AND department = ?";
...
<body class="font-sans text-gray-800 flex flex-col md:flex-row min-h-screen">
    ...
    <main
        ...
        <header class="mb-8 shrink-0">
            <h2 class="text-4xl font-black text-gray-800 tracking-tight">Declined Applications</h2>
            <p class="text-gray-600 font-medium text-lg italic">All declined Return to Work requests</p>
        </header>
